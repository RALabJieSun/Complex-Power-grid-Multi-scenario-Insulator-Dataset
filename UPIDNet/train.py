...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='models/ourmodel+CARAFE.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/IDID.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--name', default='ourmodel(IDID)', help='save to project/name')
